            ...
            <div class="table-content">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="coloredit.php?color_id=<?php echo $result['color_id'] ?>" class="btn btn-primary">Sửa</a>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="colordelete.php?color_id=<?php echo $result['color_id'] ?>" class="btn btn-danger">Xóa</a>
                            </div>
                            </div>
                        </div>
                        </div>
